...
public final class AppConstant {
	public static final String APPLICATION_NAME = "Sage FTP File Cataloger App (v2015.05.21)";
	...
	//--This datetime format is expected to be file system platform independent since NIO2 acts as a platform independent interface to the file system
	public static final String FILESDATETIMEFORMAT = "yyyy-MM-dd'T'HH:mm:ss";
